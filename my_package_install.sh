...
TOOL="git rsync wine wine_gecko doublecmd-gtk2 mlocate oxygen-icons virtualbox virtualbox-guest-utils virtualbox-guest-iso ipython   "
SYSTEM="ntfs-3g wqy-zenhei wqy-microhei wqy-bitmapfont cmake libpng12 fcitx fcitx-configtool os-prober  "

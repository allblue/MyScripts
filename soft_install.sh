...
SOFT_NETWORK="aria2 filezilla fqterm-git google-chrome thunderbird thunderbird-i18n-zh-cn"
...
SOFT_VIDEO="deepin-movie handbrake handbrake-cli  smplayer smplayer-themes vlc "

...
SOFT_NETWORK="aria2 filezilla fqterm-git chromium palemoon-bin palemoon-i18n-default thunderbird thunderbird-i18n-zh-cn"
SOFT_PICS="deepin-screenshot gimp gimp-help-zh_cn imagemagick mcomix "
SOFT_OFFICE="calibre geany geany-plugins goldendict kindlegen libreoffice-fresh libreoffice-fresh-zh-CN wiznote wps-office "
...
SOFT_LOCAL="aliedit dynamips genymotion gns3-converter gns3-server gns3-gui  menda-themes menda-themes-dark pycharm-professional tleamviewer10 ttf-wps-fonts wine-qqintl xnviewmp"
